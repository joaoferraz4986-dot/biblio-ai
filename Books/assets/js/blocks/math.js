...
(function () {
  ...
  B.register({
    type: 'math', label: 'Fórmula (LaTeX)', group: 'diagrama', icon: 'sparkles',
    ...
    example: { type: 'math', tex: 'E = mc^2', caption: 'energia de repouso' },
    defaults: function () { return { tex: 'a^2 + b^2 = c^2', caption: '' }; },
    fields: [
      { key: 'tex', label: 'LaTeX', kind: 'code', rows: 3, required: true },
      { key: 'caption', label: 'Legenda', kind: 'line' }
    ],
    summary: function (b) { return (b.caption ? Books.inline.toPlain(b.caption) + ' · ' : '') + b.tex; },
    render: function (b) {
      var el = h('div', { class: 'b-math__eq' });
      el.dataset.math = b.tex || '';
      el.dataset.display = '1';
      el.textContent = b.tex || '';
      var fig = h('figure', { class: 'b-math' }, h('div', { class: 'b-math__scroll' }, el));
